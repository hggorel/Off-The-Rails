...
function move_player()
 ...
 local tile_above_collidable = fget(tile_above, 0)
	...
	if (player.x-camx>(64+allowance)) then
		if camx<=20 and level == 0 then
			camx+=speed
		end
		if camx<=122 and level == 1 then
			camx+=speed
		end
		if camx<=118 and level == 2 then
			camx+=speed
		end
		if camx<=110 and level == 3 then
			camx+=speed
		end
		if camx<=100 and level == 4 then
			camx+=speed
		end
	end
 	...
 	if tile_character_on ==61 or tile_character_on == 179 then
 		...
 		if (level==2) then
 			...
 			for a in all(extras) do
 				...
 				create_npc(70,24,64,"guy")
 				create_npc(120,64,74,"ylady")
...
function animate_magic_ball(ball)
	...
	if(ball.sprite > 177) ball.sprite = 176
end
...
function _update()
	...
	for e in all(danger) do
 	...
 	local tile_above_collidable = fget(tile_above, 0)
		...
		if(e.sprite == 176 or e.sprite == 177) then
			animate_magic_ball(e)
		end

		if(e.sprite != 176 and e.sprite != 177) then
...
function _drawmapsprites()
	--multiplied in editor values by eight to fit map values
		...
		spr(41,13.5*8,04*8)
		spr(42,12.5*8,04*8)
		spr(41,08*8,08*8,1,1,true,false) --booth 1
		spr(41,10*8,08*8)	--booth 2
		spr(41,15*8,08*8,1,1,true,false) --booth 3
		spr(41,17*8,08*8) --booth 4
		...
		if level==4 then
		pal(2,132,1)
		spr(41,04*8,12*8,1,1,true,false)
		spr(41,02*8,12*8,1,1,true,false)
		spr(41,24*8,12*8)
		end
end
...
function titledraw()
	...
	rect(0, 0, 127, 127)
		...
		print("press z for settings-controls",3,11,7)
...
function pausedraw()
		rectmove()
		color(14)
		pal(14,133,1) --replace pink with 131
		...
		if sel.place == 2 then
		print("a cuppa tea",20,40,7)
		print("still hot-yeowch! too hot",15,50,7)
		end
		if sel.place == 3 then
...
function _moveextra()
	...
	for extra in all(extras) do
		...
		if extra.kind=="ylady" then
			extra.sprite+=.5
			if(extra.sprite > 67) then
				extra.sprite = 66
			end
		end
		if extra.kind=="guy" then
		extra.sprite+=.6
			if(extra.sprite > 75) then
				extra.sprite = 74
			end
		end
	end
...
function drawclouds()
	...
	if level==0 then
	moveclouds()
	spr(cloud.spr1,cloud.x-10,80)
	spr(cloud.spr2,cloud.x-20,48)
	end
	if level == 1 then
	...
	moveclouds()
	spr(cloud.spr1, cloud.x, 24)
	spr(cloud.spr2, cloud.x+10, 20)
	spr(cloud.spr1, cloud.x+20, 54)
	end
	if level==4 then
	rectfill(0, 0, 225, 120, 1)
	rectfill(50,100,180,140,0)
	moveclouds()
	spr(stars.sp,stars.x,stars.y)
	spr(stars.sp+1,stars.x+10,stars.y-40)
	spr(stars.sp+2,stars.x+30,stars.y-26)
...
if cloud.x > 260 and level < 4 then
	cloud.x = -5
end
end
...
__gfx__

...

...

...
00000000000000007566665775666657aa44449a756666577566665777777777d444444d07000000000000000000000000000000000000000000000000000000
...

...

...
__map__

...

